...
**Note:** As of v2, welcome messages are no longer automatically sent to players on first join. The mod only displays a basic chat message. This example shows how you would create a custom welcome message in your own mod if desired.
