...
- **MSDF textures** are generated once per glyph using analytical Bézier distance computation with edge coloring and error correction, then cached in a 4096-entry LRU cache. No per-frame cost for MSDF quality processing.
