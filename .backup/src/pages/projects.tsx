...
import {projects, games, allTags} from '@site/src/data/projects';
...
export default function ProjectsPage(): ReactNode {
  ...
  const filteredProjects = useMemo(() => {
    return projects.filter((project) => {
      const gameMatch = selectedGame === 'all' || project.game === selectedGame;
      const tagsMatch =
        selectedTags.length === 0 ||
        selectedTags.every((tag) => project.tags.includes(tag));
      return gameMatch && tagsMatch;
    });
  }, [selectedGame, selectedTags]);
      ...
      <div className={styles.projectsPage}>
        <div className="container">
          <header className={styles.pageHeader}>
            ...
            <p>Explore all my projects for Minecraft - mods, APIs, and more</p>
          </header>
